...
function joining(arr, separator) {
    var str = "";
    for (var ii = 0; ii < arr.length; ii++) {
        if (ii < arr.length - 1) {
            str += arr[ii] + separator;
        } else {
            str += arr[ii];
        }
    }
...
console.log(joining(arr1, separator1))
console.log(joining(arr2, separator2))
console.log(joining(arr3, separator3))
console.log(joining(arr4, separator4))
console.log(joining(arr5, separator5))
